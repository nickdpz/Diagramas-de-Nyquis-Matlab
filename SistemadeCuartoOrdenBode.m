...
p=(datos(:,2))';
m=(datos(:,3))';
figure('Name','Sistema de Cuarto Orden','NumberTitle','off','Color','white','Position',[0 20 900 650]);
subplot(2,1,1);
semilogx(fout,10*log(mag),'LineWidth',2);hold on;
semilogx(f,10*log(m),'o','LineWidth',2);
%Modificacion de parametros de grafica
title({'Magnitud Sistema de Cuarto Orden';''},'FontSize',13,'Color', 'blue');
...
title('Fase Sistema de Cuarto Orden','FontSize',13,'Color', 'blue');
xlabel('Frecuencia [Hz]','FontSize',12,'FontWeight','bold');
